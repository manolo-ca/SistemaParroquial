...
import { ReciboService } from './administrar-recibos.service';
import swal from 'sweetalert2';

@Component({
  selector: 'app-administrar-recibos',
  templateUrl: './administrar-recibos.component.html',
})

export class AdministrarRecibosComponent implements OnInit {
